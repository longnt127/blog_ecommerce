<?php
    class post extends DController{
        ...
        public function update_category_post($id){
            ...
            if($result==1){
                $message['msg'] = "Cập nhập danh mục bài viết thành công";
                header('Location:'.BASE_URL."/post/list_category?msg=".urlencode(serialize($message)));
            }else{
                $message['msg'] = "Cập nhập danh mục bài viết thất bại";
                header('Location:'.BASE_URL."/post/list_category?msg".urlencode(serialize($message)));
            }
        }
        ...
        public function update_post($id){
            ...
            if($result == 1){
                ...
                $message['msg'] = "Cập nhập bài viết thành công";
                header('Location:'.BASE_URL."/post/list_post?msg=".urlencode(serialize($message)));
            }else{
                $message['msg'] = "Cập nhập bài viết thất bại";
                header('Location:'.BASE_URL."/post/list_post?msg".urlencode(serialize($message)));
            }
        }
