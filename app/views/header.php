                                    ...
                                    <div class="cate_pro">
                                        <div id='cssmenu_flyout' class="display_destop_menu">
                                            <ul>
                                                ...
                                                <a href='<?php echo BASE_URL ?>sanpham/danhmuc/<?php echo $cate['id_category_product'] ?>'><span><?php echo $cate['titlte_category_product'] ?></span></a>
                                ...
                                <ul>
                                    ...
                                    ?>
                                        ...
                                        <?php
                                            ...
                                            ?> 
                                            <li><a href="<?php echo BASE_URL ?>tintuc/danhmuc/<?php echo $cate_post['id_category_post'] ?>"><span><?php echo $cate_post['tittle_category_post'] ?></span></a></li>
                                            <?php
                                            }
                                            ?>
                                        </ul>
