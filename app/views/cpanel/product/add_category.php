...
<div class="col-md-6">
    ...
    <div class="form-group">
        ...
        <input type="text" name="titlte_category_product" class="form-control" placeholder="Ten danh muc" >
    </div>
    <div class="form-group">
        <label for="pwd">Danh mục</label>
        <input type="text" name="desc_category_product" class="form-control" placeholder="Mieu ta" >
    </div>
