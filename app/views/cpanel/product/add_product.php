...
<div class="col-md-6">
    ...
    <div class="form-group">
        ...
        <input type="text" name="tittle_product" class="form-control" placeholder="Tên sản phẩm" >
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="quantity_product" class="form-control" placeholder="Số lượng sản phẩm" >
    </div>
    <div class="form-group">
        ...
        <select class="form-control" name="category_product" >
            ...
            ?>
            <option value="<?php echo $cate['id_category_product'] ?>"> <?php echo $cate['titlte_category_product'] ?> </option>
            <?php 
                }
            ?>
